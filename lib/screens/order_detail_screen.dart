...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Future<void> _loadFavoriteStatus() async {
    try {
      ...
      // pakai method isFavorited dari SupabaseService
      final fav = await _svc.isFavorited(sellerId);
      if (!mounted) return;
      setState(() {
        _isFavorite = fav;
      });
    } catch (_) {
      // boleh diabaikan, jangan bikin crash kalau ada error kecil
    }
  }
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  try {
                    // toggle di DB
                    await _svc.toggleFavorite(sellerId);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _itemsList(),
              const SizedBox(height: 12),
              if (!_loadingItems && _error == null)
                Text(
                  'Total: Rp${_computedTotal().toInt()}',
